...
class VLNBERT(nn.Module):
    ...
    def forward(self, mode, sentence, token_type_ids=None,
                ...
                position_ids=None, action_feats=None, pano_feats=None, cand_feats=None, obj_feats=None):
        ...
        if mode == 'language':
            ...
            h_t, logit, attended_language, attended_visual = self.vln_bert(mode, state_feats,
                attention_mask=attention_mask, lang_mask=lang_mask, vis_mask=vis_mask, img_feats=cand_feats, obj_feats=obj_feats)
